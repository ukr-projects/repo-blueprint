...
<div align="center">
  <img src="../assets/repo-blueprint-banner.jpg" alt="Project Banner" width="100%">
</div>
...
- 📃 Changelog: [Repo Changelog](https://github.com/ukr-projects/repo-blueprint/blob/main/docs/CHANGELOG.md)
---
